//Original Code taken from https://github.com/perliedman/leaflet-control-geocoder
//listof allowed OSM Types, all others will be removed
//despite of "administrative" which is a special case
var allowedOSMTypes = ["village","city"];

var restrictedOSMTypes = ["village","city"];
      ...
      _proto.geocode = function geocode(query, cb, context) {
        ...
        getJSON(this.options.serviceUrl + 'search', params, function (data) {
          ...
          for (var i = data.length - 1; i >= 0; i--) {
            ...
            //attach custom icons to the allowed types 
            if(results[i].properties.type == "city")
            {
              results[i].icon = "../static/img/icons/city.svg";
            }
            if(results[i].properties.type == "village")
            {
            results[i].icon = "../static/img/icons/village.svg";
            }
            if(results[i].properties.type == "administrative")
            {
            results[i].icon = "../static/img/icons/administrative.svg";
            }
    ...
    var GeocoderControl = /*#__PURE__*/function (_EventedControl) {
      ...
      _proto._createAlt = function _createAlt(result, index) {
        ...
        var li = L.DomUtil.create('li', ''),
            ...
            //give the icons a class so we can reference them in the css
            icon = this.options.showResultIcons && result.icon ? L.DomUtil.create('img', 'geocoder-control-list-image', a) : null,
